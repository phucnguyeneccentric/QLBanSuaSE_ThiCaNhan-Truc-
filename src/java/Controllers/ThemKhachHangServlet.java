...
public class ThemKhachHangServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("btnThemMoi") != null) {
            kh = new KhachHang();
            kh.setMaKhachHang(request.getParameter("txtMaKH"));
            kh.setTenKhachHang(request.getParameter("txtTenKH"));
            kh.setDiaChi(request.getParameter("txtDiaChi"));
            kh.setDienThoai(request.getParameter("txtDienThoai"));
            kh.setEmail(request.getParameter("txtEmail"));
